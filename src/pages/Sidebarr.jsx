const Sidebar = () => {
    ...
    return (
        <>
            <nav
                className="fixed top-0 left-0 w-full h-full space-y-8 bg-white border-r sm:w-80">
                        ...
                        <ul className="flex-1 px-4 text-sm font-medium">
                            {
                                navigation.map((item, idx) => (
                                    <li key={idx}>
                                        <a href={item.href} className="flex items-center p-2 text-gray-600 duration-150 rounded-lg gap-x-2 hover:bg-gray-50 active:bg-gray-100">
                            ...
                            <div className="px-4 py-4 border-t">
                                <div className="flex items-center gap-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a
                                            href="javascript:void(0)"
                                            className="block mt-px text-xs text-gray-600 hover:text-indigo-600"
                                        >
                                            View profile
                                        </a>
                                    </div>
