  ...
  const cardvs =[
    {
      ...
      description : "Easily create, prioritize, and categorize tasks to streamline your workflow and improve efficiency."
    },
    {
      icon : card
,
      title : "Seamless Team Collaboration",
      description : "Assign tasks, leave comments, and collaborate effortlessly to keep everyone on the same page."
 ...
 ,
      ...
      description : "Customize task stages, automate processes, optimize productivity with a system that works for you."
...
,
      ...
      description : "Monitor task completion, track milestones, and visualize progress with detailed insights."
...
{/* <section >
  ...
  />
<div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white z-0">
...
<section>
  <div className="relative w-full min-h-[400px] sm:min-h-[500px] md:min-h-[700px] flex items-center justify-center">
    ...
    <div className="relative z-0 text-white text-center px-6 sm:px-12">
...
<section className=" w-4/5 m-auto justify-center items-center h-auto ">
  ...
  <div className="bg-blue-300 w-full py-20 relative">
    <section className="flex flex-col items-center justify-between w-4/5 gap-10 m-auto md:flex-row">
      <div className="flex flex-col gap-6 text-center md:text-left">
        <h2 className="text-subheading text-primary font-bold">
          Let’s try a new Experience with us
        </h2>
        <p className="text-[18px] text-gray-700">
          Taskify streamlines task management, collaboration, progress tracking, and workflows, keeping teams productive and aligned with an intuitive interface.
        </p>
      </div>
...
<div className="bg-blue-300 h-full w-full -mt-[80px] ">
  <section className="flex flex-col  items-center justify-between w-4/5 gap-10 m-auto md:flex-row">
          <div className="flex flex-col gap-10 ">
            <h2 className="font-family text-subheading text-primary font-bold">
 ...
 <div className="flex items-center justify-center ">
  ...
  <div className="absolute -bottom-1 left-0 w-full ">
    <svg 
      ...
      viewBox="0 0 1200 120" 
      preserveAspectRatio="none"
      className="w-full h-auto fill-white  rotate-180"
    >
